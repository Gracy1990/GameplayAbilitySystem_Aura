	...
	FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	for (const TTuple<FGameplayTag, FGameplayTag>& Pair : FAuraGameplayTags::Get().DamageTypesToResistances)
	{
		...
		if (UAuraAbilitySystemLibrary::IsRadialDamage(EffectContextHandle))
		{
			...
			// 2. create delegate OnDelegate, broadcast damage received in TakeDamage
			// 3. bind lambda to OnDamageDelegate on the victim here
			// 4. call UGameplayStatics::ApplyRadialDamagewithFollowoff to cause damage (this will result in TakeDamage being called
	...
	//Critical Hit Resistance reduces Critical Hit chance by a certain percntage
	...
	//Double damage plus a bous if critical hit
